...
def create_pdf_page(user_text, model_text, output_path, show_headings=True, user_heading="User Message", model_heading="Model Response"):
    ...
    try:
        ...
        if user_text:
            ...
            user_text_html = markdown.markdown(user_text, extensions=['tables', 'nl2br', 'fenced_code', 'codehilite'])
        ...
        if model_text:
            ...
            model_text_html = markdown.markdown(model_text, extensions=['tables', 'nl2br', 'fenced_code', 'codehilite'])
